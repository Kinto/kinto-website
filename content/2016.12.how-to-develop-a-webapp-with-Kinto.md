...
Kinto is a perfect fit for this application as once installed, Kinto provides a flexible enough API tohandle other APIs.
...
You can use [kinto-admin](http://kinto.github.io/kinto-admin/) plugin to easily manage your buckets, collections and records.
...
An ephemeral instance is also available on this server: [https://kinto.dev.mozaws.net/v1/](https://kinto.dev.mozaws.net/v1/).
